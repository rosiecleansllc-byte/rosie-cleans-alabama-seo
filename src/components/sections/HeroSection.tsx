        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-10">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-white text-brand-green font-bold text-base sm:text-lg px-6 py-3.5 rounded-xl shadow-lg hover:shadow-xl hover:bg-green-50 transition-all duration-200 hover:-translate-y-0.5"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-transparent border-2 border-white text-white font-bold text-base sm:text-lg px-6 py-3.5 rounded-xl hover:bg-white/10 transition-all duration-200"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
