      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <span className="font-bold text-[#111111] text-base leading-tight tracking-tight">
              Rosie Cleans <span style={{ color: "#75D3DF" }}>Alabama</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 text-sm font-semibold text-[#555555] hover:text-[#111111] transition-colors"
            >
