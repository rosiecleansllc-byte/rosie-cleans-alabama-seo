        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-bold text-white text-base tracking-tight">Rosie Cleans Alabama</span>
            </div>
            ...
            <a
              href={PHONE_HREF}
              className="flex items-center gap-2 text-sm font-semibold transition-colors hover:text-teal-light"
              style={{ color: "#75D3DF" }}
            >
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold text-white text-sm mb-4 uppercase tracking-wide">Services</h3>
          ...
          {/* Service Areas */}
          <div>
            <h3 className="font-semibold text-white text-sm mb-4 uppercase tracking-wide">Service Areas</h3>
            <ul className="space-y-2.5">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-white text-sm mb-4 uppercase tracking-wide">Quick Links</h3>
            <ul className="space-y-2.5">
              {[
